...
class ComboSettingsActivity : ProfileSettingsActivity<ComboBean>(R.layout.layout_combo_settings) {

    override fun createEntity() = ComboBean()

    val proxyList = ArrayList<ProxyEntity>()

    override fun ComboBean.init() {
        DataStore.profileName = name
        DataStore.urlTestInterval = interval
        DataStore.serverProtocol = proxies.joinToString(",")
    }

    override fun ComboBean.serialize() {
        name = DataStore.profileName
        interval = DataStore.urlTestInterval
    ...
    override fun PreferenceFragmentCompat.createPreferences(
        ...
        addPreferencesFromResource(R.xml.combo_preferences)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.setTitle(R.string.combo_settings)
        ...
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { (resultCode, data) ->
            if (resultCode == Activity.RESULT_OK) runOnDefaultDispatcher {
                ...
                if (!testProfileAllowed(profile)) {
                    onMainDispatcher {
                        MaterialAlertDialogBuilder(this@ComboSettingsActivity).setTitle(R.string.circular_reference)
        ...
        fun bind() {
            binding.root.setOnClickListener {
                ...
                selectProfileForAdd.launch(
                    Intent(
                        this@ComboSettingsActivity, ProfileSelectActivity::class.java
                    )
                )
            }
        }
